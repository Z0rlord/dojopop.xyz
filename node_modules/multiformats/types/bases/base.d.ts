...
export type BaseEncoder = import('multiformats/bases/interface').BaseEncoder;
export type BaseDecoder = import('multiformats/bases/interface').BaseDecoder;
export type BaseCodec = import('multiformats/bases/interface').BaseCodec;
export type Multibase<T extends string> = import('multiformats/bases/interface').Multibase<T>;
export type MultibaseEncoder<T extends string> = import('multiformats/bases/interface').MultibaseEncoder<T>;
export type MultibaseDecoder<Prefix extends string> = import('multiformats/bases/interface').MultibaseDecoder<Prefix>;
export type UnibaseDecoder<Prefix extends string> = import('multiformats/bases/interface').UnibaseDecoder<Prefix>;
export type CombobaseDecoder<Prefix extends string> = import('multiformats/bases/interface').CombobaseDecoder<Prefix>;
export type Decoders<Prefix extends string> = Record<Prefix, UnibaseDecoder<Prefix>>;
export type MultibaseCodec<T> = import('multiformats/bases/interface').MultibaseCodec<T>;
/**
...
declare class Decoder<Base extends string, Prefix extends string> implements MultibaseDecoder<Prefix>, UnibaseDecoder<Prefix>, BaseDecoder {
     ...
     */
    or<OtherPrefix extends string>(decoder: import("multiformats/bases/interface").UnibaseDecoder<OtherPrefix> | ComposedDecoder<OtherPrefix>): ComposedDecoder<Prefix | OtherPrefix>;
}
/**
 * @template {string} Prefix
...
declare class ComposedDecoder<Prefix extends string> implements MultibaseDecoder<Prefix>, CombobaseDecoder<Prefix> {
    ...
    decoders: Record<Prefix, import("multiformats/bases/interface").UnibaseDecoder<Prefix>>;
    /**
     * @template {string} OtherPrefix
     * @param {UnibaseDecoder<OtherPrefix>|ComposedDecoder<OtherPrefix>} decoder
     * @returns {ComposedDecoder<Prefix|OtherPrefix>}
