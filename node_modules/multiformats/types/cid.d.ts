...
export class CID {
   ...
   */
     ...
     */
    static parse<Prefix extends string>(source: string, base?: import("multiformats/bases/interface").MultibaseDecoder<Prefix> | undefined): CID;
    /**
    ...
    code: number;
    version: CIDVersion;
    multihash: import("multiformats/hashes/interface").MultihashDigest;
    bytes: Uint8Array;
    byteOffset: number;
    byteLength: number;
    /** @private */
     ...
     * @returns {string}
     */
    toString(base?: import("multiformats/bases/interface").MultibaseEncoder<any> | undefined): string;
    toJSON(): {
        code: number;
        version: CIDVersion;
        hash: Uint8Array;
...
export type MultihashDigest = import('multiformats/hashes/interface').MultihashDigest;
export type CIDVersion = 0 | 1;
export type MultibaseEncoder<Prefix> = import('multiformats/bases/interface').MultibaseEncoder<Prefix>;
export type MultibaseDecoder<Prefix> = import('multiformats/bases/interface').MultibaseDecoder<Prefix>;
